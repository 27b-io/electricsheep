...
**Deliverable:** `mcp call sentiment.get_state` works. Deployed on the cluster in `mcp` namespace.

### Phase 3: OpenClaw Integration (Week 3)

- Add `mcp-sentiment` to MCP config
...
| Deployment | Container + cluster | Linux | Existing infrastructure |
